...
```rust
// components.rs
{{#include ../../../code/rust-sokoban-c03-02/src/components.rs:14:17}}
```
...
```rust
// entities.rs
{{#include ../../../code/rust-sokoban-c03-02/src/entities.rs:47:60}}
```
...
```rust
// entities.rs
{{#include ../../../code/rust-sokoban-c03-02/src/entities.rs:4:12}}
```
...
```rust
// resources.rs
{{#include ../../../code/rust-sokoban-c03-02/src/resources.rs:33:36}}
```
...
```rust
// resources.rs
{{#include ../../../code/rust-sokoban-c03-02/src/resources.rs:38:42}}
```
...
```rust
// rendering_system.rs
{{#include ../../../code/rust-sokoban-c03-02/src/systems/rendering_system.rs:18}}
    //...
{{#include ../../../code/rust-sokoban-c03-02/src/systems/rendering_system.rs:30:49}}
```
...
```rust
// rendering_system.rs
{{#include ../../../code/rust-sokoban-c03-02/src/systems/rendering_system.rs:52:77}}

            //...

{{#include ../../../code/rust-sokoban-c03-02/src/systems/rendering_system.rs:84}}

        //...

{{#include ../../../code/rust-sokoban-c03-02/src/systems/rendering_system.rs:93:94}}
```
